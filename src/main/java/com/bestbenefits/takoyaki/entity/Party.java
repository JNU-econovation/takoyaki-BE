...
public class Party {
    ...
    @Enumerated(EnumType.STRING) private ActivityLocation activityLocation;
    @Enumerated(EnumType.STRING) private ContactMethod contactMethod;

    @Column(length = 100) private String title;
    @Column(columnDefinition = "TEXT") private String body;

    @Column private LocalDate plannedClosingDate; //마감 날짜
    @Column private LocalDate plannedStartDate; //활동 시작 날짜

    @Column private int recruitNumber; //모집 인원
    @Column private int activityDuration; //활동 기간
    ...
    @Column private LocalDateTime modifiedAt; //글 수정 일시
